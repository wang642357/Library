...
import static com.js.library.common.immersionbar.Constants.IMMERSION_EMUI_NAVIGATION_BAR_HIDE_SHOW;
import static com.js.library.common.immersionbar.Constants.IMMERSION_MIUI_NAVIGATION_BAR_HIDE_SHOW;
import static com.js.library.common.immersionbar.Constants.IMMERSION_NAVIGATION_BAR_HEIGHT;
import static com.js.library.common.immersionbar.Constants.IMMERSION_NAVIGATION_BAR_HEIGHT_LANDSCAPE;
import static com.js.library.common.immersionbar.Constants.IMMERSION_NAVIGATION_BAR_WIDTH;
import static com.js.library.common.immersionbar.Constants.IMMERSION_STATUS_BAR_HEIGHT;
...
class BarConfig {
    ...
    private boolean hasNavBar(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            if (Settings.Global
                    .getInt(activity.getContentResolver(), IMMERSION_MIUI_NAVIGATION_BAR_HIDE_SHOW, 0) != 0) {
                return false;
            }
            ...
            if (OSUtils.isEMUI()) {
                if (OSUtils.isEMUI3_x() || Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    if (Settings.System
                            .getInt(activity.getContentResolver(), IMMERSION_EMUI_NAVIGATION_BAR_HIDE_SHOW, 0)
                            != 0) {
                        return false;
                    }
                } else {
     ...
     * A navigation bar may appear on the right side of the screen in certain configurations.
     *
