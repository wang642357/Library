...
public class BarParams implements Cloneable {
    ...
    /**
     * 状态栏颜色 The Status bar color.
     */
    @ColorInt
    public int statusBarColor = Color.TRANSPARENT;
    /**
     * 导航栏颜色 The Navigation bar color.
     */
    @ColorInt
    ...
    /**
     * 导航栏透明度 The Navigation bar alpha.
     */
    @FloatRange(from = 0f, to = 1f)
    ...
    /**
     * 有导航栏的情况，全屏显示 The Full screen.
     */
    public boolean fullScreen = false;
    /**
     * 是否隐藏了导航栏 The Hide navigation bar.
     */
    ...
    /**
     * 状态栏字体深色与亮色标志位 The Dark font.
     */
    public boolean statusBarDarkFont = false;

    /**
     * 导航栏图标深色与亮色标志位 The Navigation bar dark icon.
     */
    public boolean navigationBarDarkIcon = false;
    /**
     * 是否启用 自动根据StatusBar颜色调整深色模式与亮色模式 The Auto status bar dark mode enable.
     */
    public boolean autoStatusBarDarkModeEnable = false;

    /**
     * 是否启用 自动根据NavigationBar颜色调整深色模式与亮色模式 The Auto navigation bar dark mode enable.
     */
    ...
    /**
     * 解决标题栏与状态栏重叠问题 The Fits.
     */
    public boolean fits = false;
    /**
     * 解决标题栏与状态栏重叠问题 The Title bar view.
     */
    public View titleBarView;
    /**
     * 解决标题栏与状态栏重叠问题 The Status bar view by height.
     */
    ...
    /**
     * flymeOS状态栏字体变色 The Flyme os status bar font color.
     */
    @ColorInt
