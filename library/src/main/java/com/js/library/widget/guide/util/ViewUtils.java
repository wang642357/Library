package com.js.library.widget.guide.util;
...
public class ViewUtils {
    ...
    public static Rect getLocationInView(View parent, View child) {
        ...
        while (tmp != decorView && tmp != parent) {
            Log.i("NewbieGuide", "tmp class:" + tmp.getClass().getSimpleName());
            tmp.getHitRect(tmpRect);
            Log.i("NewbieGuide", "tmp hit Rect:" + tmpRect);
            ...
            if (tmp.getParent() instanceof ScrollView) {
                ...
                Log.i("NewbieGuide", "tmp class:" + "scrollY:" + scrollY);
                result.top -= scrollY;
            }
            if (tmp.getParent() instanceof HorizontalScrollView) {
                ...
                Log.i("NewbieGuide", "scrollX:" + scrollX);
                result.left -= scrollX;
            }
