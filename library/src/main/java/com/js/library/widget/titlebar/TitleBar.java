...
import com.js.library.widget.titlebar.style.BaseTitleBarStyle;
import com.js.library.widget.titlebar.style.TitleBarLightStyle;
import com.js.library.widget.titlebar.style.TitleBarNightStyle;
import com.js.library.widget.titlebar.style.TitleBarRippleStyle;
import com.js.library.widget.titlebar.style.TitleBarTransparentStyle;
...
public class TitleBar extends FrameLayout
    ...
    public void setLayoutParams(ViewGroup.LayoutParams params) {
        ...
        if (params.height == ViewGroup.LayoutParams.WRAP_CONTENT) {
            mMainLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, mCurrentStyle.getTitleBarHeight()));
        }
