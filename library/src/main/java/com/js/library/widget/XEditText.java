...
public class XEditText extends AppCompatEditText {
    ...
    private void dealWithInputTypes(boolean fromXml) {
        ...
        if (isPwdInputType) {
            ...
            if (mShowPwdResId == -1)
                mShowPwdResId = R.drawable.ic_xet_show_password_24dp;
            if (mHidePwdResId == -1)
                mHidePwdResId = R.drawable.ic_xet_hide_password_24dp;
            ...
            if (mTogglePwdDrawable != null) {
                if (mShowPwdResId == R.drawable.ic_xet_show_password_24dp ||
                        mHidePwdResId == R.drawable.ic_xet_hide_password_24dp) {
            ...
            if (!disableClear) {
                mBitmap = getBitmapFromVectorDrawable(getContext(), mClearResId,
                        mClearResId == R.drawable.ic_xet_clear_24dp); // clearDrawable
            }
        }
