package com.js.library.widget.guide.model;
...
import com.js.library.widget.guide.listener.OnHighlightDrewListener;
import com.js.library.widget.guide.listener.OnLayoutInflatedListener;
...
public class GuidePage {
     ...
     * @param shape         高亮形状{@link com.js.library.widget.guide.model.HighLight.Shape}
     * @param round         圆角尺寸，单位dp，仅{@link com.js.library.widget.guide.model.HighLight.Shape#ROUND_RECTANGLE}有效
    ...
    public GuidePage addHighLightWithOptions(View view, HighLight.Shape shape,
                                             HighlightOptions options) {
        return addHighLightWithOptions(view, shape, 0, 0, options);
    }

    public GuidePage addHighLightWithOptions(View view, HighLight.Shape shape, int round, int padding,
                                             HighlightOptions options) {
        HighlightView highlight = new HighlightView(view, shape, round, padding);
        if (options != null) {
    ...
    public GuidePage addHighLightWithOptions(RectF rectF, HighLight.Shape shape,
                                             HighlightOptions options) {
        return addHighLightWithOptions(rectF, shape, 0, options);
    }

    public GuidePage addHighLightWithOptions(RectF rectF, HighLight.Shape shape, int round,
                                             HighlightOptions options) {
        HighlightRectF highlight = new HighlightRectF(rectF, shape, round);
        if (options != null) {
            if (options.relativeGuide != null) {
