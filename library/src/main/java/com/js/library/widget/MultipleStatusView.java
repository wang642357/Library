...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a
                .getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.layout_base_empty);
        mErrorViewResId = a
                .getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.layout_base_error);
        mLoadingViewResId = a
                .getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.layout_base_loading);
        mNoNetworkViewResId = a
                .getResourceId(R.styleable.MultipleStatusView_noNetworkView, R.layout.layout_base_error);
        mContentViewResId = a
                .getResourceId(R.styleable.MultipleStatusView_contentMainView, NULL_RESOURCE_ID);
        a.recycle();
