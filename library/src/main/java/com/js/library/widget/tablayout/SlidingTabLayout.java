package com.js.library.widget.tablayout;
 ...
 */
// TODO: 2020/4/18 增加对ViewPage2的支持
public class SlidingTabLayout extends HorizontalScrollView implements
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mSelectTextSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_selectedTextSize, sp2px(14));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                        i == mCurrentTab ? mSelectTextSize : mTextsize);
