...
package com.js.library.http.cookie.cache;
...
/**
 * This class decorates a Cookie to re-implements equals() and hashcode() methods in order to
 * identify the cookie by the following attributes: name, domain, path, secure & hostOnly.<p>
 * <p>
 * This new behaviour will be useful in determining when an already existing cookie in session must
 * be overwritten.
 */
